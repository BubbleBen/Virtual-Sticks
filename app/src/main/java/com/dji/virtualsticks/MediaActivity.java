...
public class MediaActivity extends Activity implements View.OnClickListener {
    ...
    File destDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM), "DJISample");
    ...
    private DJICameraError mCameraError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initUI();
        FPVDemoApplication.getAircraftInstance().getCamera().setStorageStateCallBack(new StorageState.Callback() {
            @Override
            public void onUpdate(@NonNull @NotNull StorageState storageState) {
                if(storageState.isInserted()) {
                    ...
                    FPVDemoApplication.getAircraftInstance().getCamera().setStorageLocation(SettingsDefinitions.StorageLocation.SDCARD, new CommonCallbacks.CompletionCallback() {
                        @Override
                    ...
                    FPVDemoApplication.getAircraftInstance().getCamera().setStorageLocation(SettingsDefinitions.StorageLocation.INTERNAL_STORAGE, new CommonCallbacks.CompletionCallback() {
                        @Override
                        public void onResult(DJIError djiError) {
                        }
                    });
    ...
    protected void onDestroy() {
        ...
        if (FPVDemoApplication.getCameraInstance() != null) {
            if (isMavicAir2() || isAir2S() || isM300()) {
                FPVDemoApplication.getCameraInstance().exitPlayback(djiError -> {
                    if (djiError != null) {
                        FPVDemoApplication.getCameraInstance().setFlatMode(SettingsDefinitions.FlatCameraMode.PHOTO_SINGLE, djiError1 -> {
                            if (djiError1 != null) {
                ...
                FPVDemoApplication.getCameraInstance().setMode(SettingsDefinitions.CameraMode.SHOOT_PHOTO, djiError -> {
                    if (djiError != null) {
    ...
    void initUI() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(MediaActivity.this, RecyclerView.VERTICAL,false);
        ...
        if (FPVDemoApplication.getProductInstance() == null) {
            ...
            if (null != FPVDemoApplication.getCameraInstance() && FPVDemoApplication.getCameraInstance().isMediaDownloadModeSupported()) {
                ...
                if (null != mMediaManager) {
                    ...
                    if (isMavicAir2() || isAir2S() || isM300()) {
                        FPVDemoApplication.getCameraInstance().enterPlayback(djiError -> {
                            if (djiError == null) {
                                DJILog.e(TAG, "Set cameraMode success");
                                FPVDemoApplication.getCameraInstance().getMode(new CommonCallbacks.CompletionCallbackWith<SettingsDefinitions.CameraMode>() {
                                    @Override
                                    public void onSuccess(SettingsDefinitions.CameraMode cameraMode) {
                                        DJILog.e(TAG, "camera mode is " + cameraMode);
                                    }
                        ...
                        FPVDemoApplication.getCameraInstance().setMode(SettingsDefinitions.CameraMode.MEDIA_DOWNLOAD, error -> {
                            if (error == null) {
                                DJILog.e(TAG, "Set cameraMode success");
                                showProgressDialog();
                                getFileList();
                    ...
                    if (FPVDemoApplication.getCameraInstance().isMediaDownloadModeSupported()) {
                        DJILog.e(TAG, "Camera supports media download!");
                    } else {
                        DJILog.e(TAG, "Camera supports media download!");

                        setResultToToast("Camera does not support media download!");
                    }
...
//        if (FPVDemoApplication.getCameraInstance().isPlaybackSupported()) {
//            mPlaybackManager = FPVDemoApplication.getCameraInstance().getPlaybackManager();
//            hideProgressDialog();
//            if (mPlaybackManager != null) {
//                mCameraError = mPlaybackManager.enterMultiplePreviewMode();
//                if (mCameraError == null) {
//                    mCameraError = mPlaybackManager.selectAllFilesInPage();
//                    if (mCameraError == null) {
//                        mPlaybackManager.downloadSelectedFiles(destDir, new PlaybackManager.FileDownloadCallback() {
//                            @Override
//                            public void onStart() {
//                                DJILog.e(TAG, "files have started downloading");
//                            }
//
//                            @Override
//                            public void onEnd() {
//                                DJILog.e(TAG, "files have finished downloading");
//                            }
//
//                            @Override
//                            public void onError(Exception e) {
//                                DJILog.e(TAG, "error in downloading files" + e.getMessage());
//                            }
//
//                            @Override
...
//                        });
//                    } else {
//                        DJILog.e(TAG, "selection error: " + mCameraError.getDescription());
//                        setResultToToast("selection error: " + mCameraError.getDescription());
//                    }
//                } else {
//                    DJILog.e(TAG, "enter multiple preview camera error: " + mCameraError.getDescription());
//                    setResultToToast("enter multiple preview camera error: " + mCameraError.getDescription());
//                }
//            } else {
//                DJILog.e(TAG, "playback manager is null");
//            }
//        } else {
//            DJILog.e(TAG, "playback not supported");
//            hideProgressDialog();
//        }
//    }
                ...
                mMediaManager.refreshFileListOfStorageLocation(storageLocation, djiError -> {
                    if (null == djiError) {
                        ...
                        if (currentFileListState == MediaManager.FileListState.UP_TO_DATE) {
                            DJILog.e(TAG, "media manager file list state is UP_TO_DATE");
                        } else if (currentFileListState == MediaManager.FileListState.UNKNOWN) {
                            DJILog.e(TAG, "media manager file list state is UNKNOWN");
                        } else if (currentFileListState == MediaManager.FileListState.INCOMPLETE) {
                            DJILog.e(TAG, "media manager file list state is INCOMPLETE");
                        } else if (currentFileListState == MediaManager.FileListState.RESET) {
                            DJILog.e(TAG, "media manager file list state is RESET");
                        } else if (currentFileListState == MediaManager.FileListState.RENAMING) {
                            DJILog.e(TAG, "media manager file list state is RENAMING");
                        } else if (currentFileListState == MediaManager.FileListState.SYNCING) {
                            DJILog.e(TAG, "media manager file list state is SYNCING");
                        } else {
                            DJILog.e(TAG, "media manager file list state is DELETING");
                        }
                        //Reset data
...
//                        currentFileListState = mMediaManager.getSDCardFileListState();
//                        DJILog.e(TAG, "2. media manager file list state is " + currentFileListState);
                        ...
                        if (mediaFileList != null) {
                            ...
                            DJILog.e(TAG, "line 445: mediaFileList size is " + mediaFileList.size());
                        }
    ...
    private class FileListAdapter extends RecyclerView.Adapter<ItemHolder> {
        ...
        public int getItemCount() {
            if (mediaFileList != null) {
                DJILog.e(TAG, "mediaFileList size is " + mediaFileList.size());
    ...
    private boolean isM300() {
        BaseProduct baseProduct = FPVDemoApplication.getProductInstance();
        if (baseProduct != null) {
            return baseProduct.getModel() == Model.DJI_MINI_2;
        }
        return false;
    }
}
...
//
//    private static final String TAG = MediaActivity.class.getName();
//    private static MediaActivity activity;
//
//    private Button mBackBtn, mDeleteBtn, mReloadBtn, mDownloadBtn, mStatusBtn;
//    private Button mPlayBtn, mResumeBtn, mPauseBtn, mStopBtn, mMoveToBtn;
//    private RecyclerView listView;
...
//    protected void onDestroy() {
//        lastClickView = null;
//        FPVDemoApplication.getCameraInstance().exitPlayback(new CommonCallbacks.CompletionCallback() {
//            @Override
...
//                if (null != mMediaManager) {
//                    mMediaManager.addUpdateFileListStateListener(this.updateFileListStateListener);
//                    FPVDemoApplication.getCameraInstance().enterPlayback(new CommonCallbacks.CompletionCallback() {
//                        @Override
//                        public void onResult(DJIError error) {
//                            if (error == null) {
//                                DJILog.e(TAG, "Set cameraMode success");
...
//                                getThumbnails();
//                            } else {
//                                DJILog.e(TAG, "error getting thumbnails");
//                            }
//                        });
//                    } else {
//                        hideProgressDialog();
...
//
//    private void getThumbnailByIndex(final int index) {
//        DJILog.e(TAG, "inside getThumbnailByIndex");
//        FetchMediaTask task = new FetchMediaTask(mediaFileList.get(index), FetchMediaTaskContent.THUMBNAIL, taskCallback);
//        scheduler.moveTaskToEnd(task);
//    }
//
...
//                }
//                if (option == FetchMediaTaskContent.THUMBNAIL) {
//                    DJILog.e(TAG, "inside thumbnail");
//                    runOnUiThread(new Runnable() {
//                        public void run() {
//                            DJILog.e(TAG, "inside runOnUIThread");
//                            mListAdapter.notifyDataSetChanged();
//                        }
//                    });
//                }
